...
namespace AgenziaLib
{
    ...
    internal class Trea
    {
        ...
        {
            //if (reqParams.ContainsKey("confrontoLocandine") && reqParams["confrontoLocandine"] == "true")
            //{
            //    List<Dictionary<string, object>> elementList = new List<Dictionary<string, object>>();
            //    elementList.AddRange(primario);
            //    //elementList.AddRange(secondario);
            //    return confrontaListeLocandina(elementList, reqParams);
            //}
            //Dictionary<string, string> colonne = new Dictionary<string, string>
            //{
            //    { "Codice", "Referenza.Codice" },
            //    { "Descrizione", "Descrizioni.Descrizione1" },
            //    { "|" , ""},
            //    { "Prezzo Continuo1", "prezzo_continuo" },
            //    { "Prezzo Continuo2", "prezzo_continuo" },
            //    { "||" , ""},
            //    { "Sconto1", "sconto" },
            //    { "Sconto2", "sconto" },
            //    { "|||" , ""},
            //    { "Prezzo Promo1", "prezzo_promo" },
            //    { "Prezzo Promo2", "prezzo_promo" },
            //    { "||||" , ""},
            //    { "Prezzo KGL1", "prezzo_kgl" },
            //    { "Prezzo KGL2", "prezzo_kgl" },
            //    { "|||||" , ""},
            //    { "Cod.Gruppo1", "Scatto.CodiceGruppo" },
            //    { "Cod.Gruppo2", "Scatto.CodiceGruppo" },
            //    { "||||||" , ""},
            //    { "P/S/C", "" },
            //};            
            ...
            //string lastCodiceGruppo = primario[0][colonne["Cod.Gruppo1"]].ToString();
            //bool gruppoChanged = false;
            ...
            //    string codicePrimario = elementoPrimario[colonne["Codice"]].ToString();
            //    var elementoCorrispondenteSecondario = secondario.FirstOrDefault(e => e[colonne["Codice"]].ToString() == codicePrimario);
            //    string[] arrayValori = new string[colonne.Count];
            ...
            //        {
            //            if (chiave == "Codice" || chiave == "Descrizione")
            //            {
            //                csvRec[chiave] = elementoPrimario[valore].ToString();
            //                //arrayValori[i] = elementoPrimario[valore].ToString();
            //            }
            //            else if (chiave.Contains("|"))
            //            {
            //                csvRec[chiave] = "";
            //            }
            //            else if (chiave == "P/S/C")
            //            {
            //                csvRec[chiave] = "Comune";
            //            }
            //            else if (chiave.ToLower().Contains("prezzo"))
            //            {
            //                string parametroDaLeggere = chiave.EndsWith("1") ? MathExt.DecimalRoundMidpoint(elementoPrimario[valore].ToDecimal()).ToString() : MathExt.DecimalRoundMidpoint(elementoCorrispondenteSecondario[valore].ToDecimal()).ToString();
            //                if (chiave == "Cod.Gruppo1" && lastCodiceGruppo == parametroDaLeggere)
            //                {
            //                    gruppoChanged = true;
            //                }
            //                csvRec[chiave] = parametroDaLeggere;
            //            }
            //            else
            //            {
            //                string parametroDaLeggere = chiave.EndsWith("1") ? elementoPrimario[valore].ToString() : elementoCorrispondenteSecondario[valore].ToString();
            //                if (chiave == "Cod.Gruppo1" && lastCodiceGruppo == parametroDaLeggere)
            //                {
            //                    gruppoChanged = true;
            //                }
            ...
            //            else if (chiave == "P/S/C")
            //            {
            //                csvRec[chiave] = "Solo Primario";
            //            }
            //            else if (chiave.ToLower().Contains("prezzo"))
            //            {
            //                string parametroDaLeggere = chiave.EndsWith("1") ? MathExt.DecimalRoundMidpoint(elementoPrimario[valore].ToDecimal()).ToString() : "N.P.";
            //                csvRec[chiave] = parametroDaLeggere;
            //            }
            //            else
            //            {
            //                string parametroDaLeggere = chiave.EndsWith("1") ? elementoPrimario[valore].ToString() : "N.P.";
            //                if (chiave == "Cod.Gruppo1" && lastCodiceGruppo == parametroDaLeggere)
            //                {
            //                    gruppoChanged = true;
            //                }
            ...
            //        if (csvRec["Prezzo Continuo1"] != csvRec["Prezzo Continuo2"])
            //        {
            //            csvResultComuni.records.Add(csvRec);
            //            differenzaTrovata = true;
            //        }
            //        if (!differenzaTrovata && csvRec["Sconto1"] != csvRec["Sconto2"])
            //        {
            //            csvResultComuni.records.Add(csvRec);
            //            differenzaTrovata = true;
            //        }
            //        if (!differenzaTrovata && csvRec["Prezzo Promo1"] != csvRec["Prezzo Promo2"])
            //        {
            //            csvResultComuni.records.Add(csvRec);
            //            differenzaTrovata = true;
            //        }
            //        if (!differenzaTrovata && csvRec["Prezzo KGL1"] != csvRec["Prezzo KGL2"])
            //        {
            //            csvResultComuni.records.Add(csvRec);
            //            differenzaTrovata = true;
            //        }
            ...
            //{
            //    Dictionary<string, string> csvRec = new Dictionary<string, string>();
            //    string codiceSecondario = elementoSecondario[colonne["Codice"]].ToString();
            //    var elementoCorrispondentePrimario = primario.FirstOrDefault(e => e[colonne["Codice"]].ToString() == codiceSecondario);

            //    // Se l'elementoSecondario non ha corrispondenza in primario, aggiungilo a risultato
            //    if (elementoCorrispondentePrimario == null)
            //    {
            //        //string[] arrayValoriSecondario = new string[colonne.Count];
            ...
            //            if (chiave == "Codice" || chiave == "Descrizione")
            //            {
            //                //arrayValoriSecondario[i] = elementoSecondario[valore].ToString();
            ...
            //            else if (chiave == "P/S/C")
            //            {
            //                csvRec[chiave] = "Solo Secondario";
            //            }
            //            else if (chiave.ToLower().Contains("prezzo"))
            //            {
            //                string val = MathExt.DecimalRoundMidpoint(elementoSecondario[valore].ToDecimal());
            //                //string parametroDaLeggere = chiave.EndsWith("2") ? MathExt.DecimalRoundMidpoint(elementoSecondario[valore].ToDecimal()).ToString() : "N.P.";
            //                string parametroDaLeggere = chiave.EndsWith("2") ? val : "N.P.";
            //                csvRec[chiave] = parametroDaLeggere;
            //            }
            //            else
            //            {
            //                string parametroDaLeggere = chiave.EndsWith("2") ? elementoSecondario[valore].ToString() : "N.P.";
            //                csvRec[chiave] = parametroDaLeggere;
            //                //arrayValoriSecondario[i] = parametroDaLeggere;
            //            }
            //        }
            //        //risultato.Add(arrayValoriSecondario);
            //        csvResultSoloSecondario.records.Add(csvRec);
            //    }
            //}

            //int count = 0;
            //Dictionary<string, string> emtyCsvEl = new Dictionary<string, string>(); //riga vuota da usare dopo
            ...
            //}
            //count = 0;
            //Dictionary<string, string> TestataComuni = new Dictionary<string, string>(); //riga vuota da usare dopo
            //foreach (var item in colonne)
            //{
            //    if (count == 0)
            //    {
            //        TestataComuni[item.Key] = "Comuni";
            //        count++;
            //    }
            //    else
            //    {
            //        TestataComuni[item.Key] = "";
            //    }
            //}
            //count = 0;
            //Dictionary<string, string> TestataPrimari = new Dictionary<string, string>(); //riga vuota da usare dopo
            //foreach (var item in colonne)
            //{
            //    if (count == 0)
            //    {
            //        TestataPrimari[item.Key] = "Solo in primario";
            //        count++;
            //    }
            //    else
            //    {
            //        TestataPrimari[item.Key] = "";
            //    }
            //}

            //count = 0;
            //Dictionary<string, string> TestataSecondari = new Dictionary<string, string>(); //riga vuota da usare dopo
            //foreach (var item in colonne)
            //{
            //    if (count == 0)
            //    {
            //        TestataSecondari[item.Key] = "Solo in secondario";
            //        count++;
            //    }
            //    else
            //    {
            //        TestataSecondari[item.Key] = "";
            //    }
            //}

            //string lastGruppoEsaminato = "";

            //if (csvResultComuni.records.Count > 0)
            //{
            //    csvResult.records.Add(TestataComuni);
            //    lastGruppoEsaminato = csvResultComuni.records[0]["Cod.Gruppo1"];
            //    foreach (var item in csvResultComuni.records)
            //    {
            //        if (item["Cod.Gruppo1"] != lastGruppoEsaminato)
            //        {
            //            csvResult.records.Add(emtyCsvEl);
            //            lastGruppoEsaminato = item["Cod.Gruppo1"];
            //        }
            //        csvResult.records.Add(item);
            //    }

            //    csvResult.records.Add(emtyCsvEl);
            //}

            //if (csvResultSoloPrimario.records.Count > 0)
            //{
            //    csvResult.records.Add(TestataPrimari);
            //    lastGruppoEsaminato = csvResultSoloPrimario.records[0]["Cod.Gruppo1"];
            //    foreach (var item in csvResultSoloPrimario.records)
            //    {
            //        if (item["Cod.Gruppo1"] != lastGruppoEsaminato)
            //        {
            //            csvResult.records.Add(emtyCsvEl);
            ...
            //if (csvResultSoloSecondario.records.Count > 0)
            //{
            //    csvResult.records.Add(TestataSecondari);
            //    lastGruppoEsaminato = csvResultSoloSecondario.records[0]["Cod.Gruppo2"];
            //    foreach (var item in csvResultSoloSecondario.records)
            //    {
            //        if (item["Cod.Gruppo2"] != lastGruppoEsaminato)
            //        {
            //            csvResult.records.Add(emtyCsvEl);
            //            lastGruppoEsaminato = item["Cod.Gruppo2"];
            //        }
            //        csvResult.records.Add(item);
            //    }
            //}
            ////string jsonResult = JsonConvert.SerializeObject(risultato);
