-- Copia di correggo4/db/correggo4_schema.sql, applicata dal deployment set
-- istanta-correggo al primo avvio di PostgreSQL, sul database di Correggo4 e
-- collegandosi come il suo ruolo, perche' le tabelle siano di sua proprieta'.
