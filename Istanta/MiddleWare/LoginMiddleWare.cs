                        ...
                        try
                        {
                            ...
                            if (response.IsSuccessStatusCode)
                            {
                                ...
                                if (utente!.autorizzato)
                                {
                                    ...
                                    //if (utente.origin != "IS")
                                    //{
                                        //UtentiFico? uf = ctx.UtentiFicos.Where(x => x.Username == utente.username && x.Origin == utente.origin).FirstOrDefault();
                                        //if (uf == null)
                                        //{
                                        //    //Creo l'utente in locale prendedo i dati dalla policy di olympus
                                        //    Utenti uIstanta = new Utenti();



                                        //    uIstanta.NomeUtente = "guestFico";
                                        ...
                                        //    uIstanta.Stato = (byte)statoUtente.FicoGuestAttivo;
                                        //    uIstanta.Data_Registrazione = DateTime.Now;
                                        //    ctx.Add(uIstanta);
                                        //    ctx.SaveChanges();

                                        //    Debug.WriteLine(DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss fff") + " -- SAVE 1" + req.Path);

                                        //    uf = new UtentiFico();
                                        //    uf.IdUtente = uIstanta.Id;
                                        //    uf.TipoUtente = (byte)utente.tipoUtente;
                                        //    uf.Username = utente.username;
                                        //    uf.Origin = utente.origin;
                                        //    uf.lastAccess = DateTime.Now;
                                        //    uf.UserData = JsonConvert.SerializeObject(utente.userPolicy);
                                        //    uf.Token = bearer;
                                        //    ctx.UtentiFicos.Add(uf);
                                        //    ctx.SaveChanges();

                                        //    Debug.WriteLine(DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss fff") + " -- SAVE 2 " + req.Path);
                                    ...
                                    //    else
                                    //    {
                                    //        throw new Exception("Utnete in Istnata loopback non trovato");
                                    //    }
                                    //}
