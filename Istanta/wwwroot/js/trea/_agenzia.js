...
class Agenzia extends IAgenzia{
    ...
    getMeccanicaCustom(idMastro, note) {
                ...
                if (meccanicaRequired == "") {
                    associazione.note.forEach(function (notaConfronto) {
                        if (note.includes(notaConfronto)) {
                            meccanicaRequired = menaboInstance.meccanicheSource.find(f => f.id == associazione.idMeccanica).nomeTraduzione;
                        }
                    });                 
                }
            });
        ...
        if (mastroFounded.meccanicaDefault == null || mastroFounded.meccanicaDefault == "") {
            ...
            try {
                let res = menaboInstance.meccanicheSource.find(f => f.id == mastroFounded.meccanicaDefault).nomeTraduzione;
                if (res != null) {
    ...
    getCustomConfronti() {
        ...
        var nuovaOpzione = $('<option>').text(opzioneConfrontoLocandine.testo)
