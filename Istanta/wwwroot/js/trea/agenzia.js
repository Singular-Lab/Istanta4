...
class Agenzia extends IAgenzia {
    ...
    aggiungiAreeInAreeOutDettaglio(htmlItem, dataItem) {
        if (!dataItem.isGruppo) {
            ...
            if (htmlItem.find(".areeInDettaglio").length > 0) {
                ...
                htmlItem.find(".areeInDettaglio").text("In vol: " + areeText);
                ...
                htmlItem.find(".fuoriAreeInDettaglio").text("Fuori vol: " + areeText);
            }
            else {
                let areeText = "";
                if (dataItem.recordInTracciato.ACComuni != null) {
            ...
            var gruppo = this.listGruppiInOut.find(f => f.codiceGruppo == dataItem.recordInTracciato[keyScattoCodiceGruppo]);
    ...
    calcolaAreaInAreaOutGruppi(list) {
        ...
        //    const lenA = (a.recordInTracciato[keyScattoCodiceGruppo] || "").split(",").length;
        //    const lenB = (b.recordInTracciato[keyScattoCodiceGruppo] || "").split(",").length;
        //    return lenB - lenA;
        //});
        ...
        gruppi.forEach(gruppo => {
            ...
            if (gruppo.recordInTracciato[keyScattoCodiceGruppo].includes("190050,434833,564717,564900,6503379")) {
                console.log("");
            }
            ...
            //var areeIn = [...elementiGruppo[0].recordInTracciato.areeIn];
            ...
            //var areeOut = [...elementiGruppo[0].recordInTracciato.areeOut];
