...
class Agenzia {
    ...
    parametriComposizioneCustom = [{ segnaposto:"reparto"}]
    ...
    AggiungiInfoPezzo(groupElements, codice, area) {
        ...
        numTroncatoPromo = parseFloat(currentElement.recordInTracciato.prezzo_offerta).toFixed(2);
        ...
        groupElements.forEach(function (item) {
            if (prezzoMinPromo == 0) {
                prezzoMinPromo = parseFloat(item.recordInTracciato.prezzo_offerta).toFixed(2);
            }
            else {
                if (parseFloat(prezzoMinPromo) > parseFloat(parseFloat(item.recordInTracciato.prezzo_offerta).toFixed(2))) {
                    prezzoMinPromo = parseFloat(item.recordInTracciato.prezzo_offerta).toFixed(2);
                }
            }

            if (prezzoMaxPromo == -1) {
                prezzoMaxPromo = parseFloat(item.recordInTracciato.prezzo_offerta).toFixed(2);
            }
            else {
                if (parseFloat(prezzoMaxPromo) < parseFloat(parseFloat(item.recordInTracciato.prezzo_offerta).toFixed(2))) {
                    prezzoMaxPromo = parseFloat(item.recordInTracciato.prezzo_offerta).toFixed(2);
                }
            }
