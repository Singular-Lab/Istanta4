...
function Main() {
  const dropzoneSingleRef = useRef<DropzoneElement | null>(null);
  const dropzoneMultipleRef = useRef<DropzoneElement | null>(null);
  const dropzoneValidationRef = useRef<DropzoneElement | null>(null);
