...
const Alert = forwardRef(
  <C extends React.ElementType = "div">(
    ...
    const info = [
      "bg-info border-info text-white", // Default
      "dark:border-info", // Dark mode
    ];
    ...
    const softInfo = [
      "bg-info border-info bg-opacity-20 border-opacity-5 text-info", // Default
      "dark:border-info dark:border-opacity-20", // Dark mode
    ];
...
// Type the Alert properly for compound component pattern
type AlertWithDismissButton = AlertComponent & {
  DismissButton: typeof DismissButton;
};

const AlertWithSubComponents = Alert as unknown as AlertWithDismissButton;
AlertWithSubComponents.DismissButton = DismissButton;
