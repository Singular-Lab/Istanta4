...
const FormTextarea = forwardRef(
  (props: FormTextareaProps, ref: FormTextareaRef) => {
    ...
    const { formTextareaSize, rounded, borderless, maxLength, onChange, ...computedProps } = props;
    
    const [charCount, setCharCount] = useState(props.defaultValue?.toString().length || props.value?.toString().length || 0);
      ...
      <div className="relative">
        <textarea
          ...
          className={twMerge([
            ...
            maxLength && "pb-6", // Aggiungo padding in basso quando c'è il contatore
            props.className,
          ])}
        />
        {maxLength && (
